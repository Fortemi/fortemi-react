// Copy each workspace package README into ../docs/packages/<pkg>.md so the
...
//
// docs/packages/ is gitignored — these pages are generated at build time.
...
const outDir = resolve(repoRoot, 'docs', 'packages');
...
for (const pkg of packages) {
  ...
  if (existsSync(src)) {
    ...
    console.log(`  packages/${pkg}/README.md -> docs/packages/${pkg}.md`);
    copied++;
  } else {
