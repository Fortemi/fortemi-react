...
import release20260800 from '../../../../docs/content/releases/v2026.8.0.md?raw'
import release20260900 from '../../../../docs/content/releases/v2026.9.0.md?raw'
import release20260902 from '../../../../docs/content/releases/v2026.9.2.md?raw'
import release20260901 from '../../../../docs/content/releases/v2026.9.1.md?raw'
...
export const PROJECT_DOCS: ProjectDoc[] = [
  ...
  doc('docs/content/releases/v2026.9.2.md', release20260902, ['docs:release']),
  doc('docs/content/releases/v2026.9.1.md', release20260901, ['docs:release']),
  doc('docs/content/releases/v2026.9.0.md', release20260900, ['docs:release']),
  doc('docs/content/releases/v2026.8.0.md', release20260800, ['docs:release']),
