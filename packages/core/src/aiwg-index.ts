...
function validateProjectedRecordShape(item: Partial<AiwgFortemiRecord>, index: number, errors: string[]): void {
  const at = 'items[' + index + ']'
...
function computeAiwgIndexHash(data: Uint8Array): string {
