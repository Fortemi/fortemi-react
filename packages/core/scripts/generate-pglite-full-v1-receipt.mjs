...
const implementationPaths = [
  ...
  'src/shard/native-full-v1-import.ts',
  'src/shard/native-identities.ts',
  'src/shard/native-lineage.ts',
  'src/shard/types.ts',
  ...
  'src/__tests__/remote-evidence-resolution.test.ts',
  'schemas/metadata-search/candidate/1.0.0/evidence-resolution.schema.json',
  'schemas/metadata-search/candidate/1.0.0/evidence-resolution-vectors.json',
  'schemas/metadata-search/candidate/1.0.0/resolution.receipt.json',
  'src/__tests__/remote-rest-contract.test.ts',
  'schemas/metadata-search/candidate/1.0.0/search-rest.schema.json',
  'schemas/metadata-search/candidate/1.0.0/search-rest-vectors.json',
  'schemas/metadata-search/candidate/1.0.0/rest.receipt.json',
  'src/__tests__/remote-evidence.test.ts',
  ...
  'src/__tests__/embedding-sets-graph.test.ts',
...
await writeFile(receiptPath, `${JSON.stringify({
  ...
  evidence: {
    ...
    assertions: [
      ...
      'explicit-archival-logical-files-reexported-byte-for-byte',
      'public-native-all-33-components-and-sidecars-semantically-reexported',
      'public-native-repository-crud-never-shadowed-by-archival-state',
      'native-skip-uses-record-owners-not-reference-endpoints',
      'native-replace-preserves-independent-set-assignments-to-selected-notes',
      'native-history-provenance-retained-identities-with-restrict-references',
      'native-selected-derivation-omissions-preserve-source-note-references',
      'native-capture-reparenting-precedes-activity-omissions',
      'native-referenced-activity-revision-omissions-roll-back',
      'retained-embedding-configuration-used-and-dimension-conflicts-rolled-back',
      'native-migration-lineage-presence-scoped-by-live-record-identity',
      'mixed-native-migration-lineage-rejected-with-typed-loss',
      'native-batch-progress-and-precommit-callback-rollback',
      'postcommit-notification-failure-retains-committed-success',
      'selected-geometry-tombstones-and-virtual-set-losses',
      'public-archival-api-independent-of-native-state-not-native-restore',
      'producer-owned-relationship-mutations-rejected-before-native-storage',
